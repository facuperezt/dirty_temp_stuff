...
def runNN(epochs, load, save, batchsize=None, runs=1, plot=True, explain=False,train_model=False):
    ...
    if load:
        nn.load_state_dict(torch.load("models/nn_baseline_None_50_001"))
    ...
    for run in range(runs):
        ...
        for i in range(0, epochs):
            ...
            if i == epochs - 1:
                if save:
                    torch.save(tmp_nn, "models/nn_baseline_None_50_001_80_stuff")
                if plot:
